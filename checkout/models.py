...
class Order(models.Model):
    ...
    # if the customte purchases the same order twice we use these to allow duplicate orders:
    original_bag = models.TextField(null=False, blank=False, default='')
    # with a stripe payment id which is guaranteed to be unique
    ...
    def update_total(self):
        ...
        """
        # The 'or 0' is added to prevent an error if we manually delete all the line items from the order
