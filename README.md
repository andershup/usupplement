...
* Google and social media sign-in option
...
* Markdownlint - for validating README.MD
...
| :---------------------------------------------------------- | :----------------------------------------------------------------- | :----- |
| CSS W3C           | style.css                                                          | PASS   |
| HTML W3C                     | templates                                                          | PASS   |
| Javascript: no major errors jshint | stripe_elements.js, base.js                                              | PASS   |
| Python PEP8                   | views<span></span>.py, models<span></span>.py, forms<span></span>.py, urls<soan></soan>.py, settings<span></span>.py, test\_\*\*.py | PASS   |
...
* Only if superuser or staff is logged in does the "Add Product" and "Create Blog" options show under account in the Navbar
...
* Adding product tested functional
